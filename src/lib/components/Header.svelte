...
<header class="p-4 md:p-6">
	...
	>
		...
		<div
			class={clsx(
				'fixed inset-0 z-40 flex flex-col items-end bg-gray-950 pr-4 pt-14 transition-transform duration-300 ease-in-out md:hidden',
		...
		>
			<button
				...
				type="button"
				class="block p-2 text-3xl text-white md:hidden"
				on:click={toggleOpen}><IconClose /></button
			>
