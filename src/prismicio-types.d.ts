...
/**
 * Item in *CaseStudies → Default → Primary → ContentRelationship*
 */
export interface CaseStudiesSliceDefaultPrimaryContentrelationshipItem {
	/**
	 * Case Study field in *CaseStudies → Default → Primary → ContentRelationship*
	 *
	 * - **Field Type**: Content Relationship
	 * - **Placeholder**: *None*
	 * - **API ID Path**: case_studies.default.primary.contentrelationship[].case_study
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
...
export interface CaseStudiesSliceDefaultPrimary {
	...
	/**
	 * ContentRelationship field in *CaseStudies → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: case_studies.default.primary.contentrelationship[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	contentrelationship: prismic.GroupField<
		Simplify<CaseStudiesSliceDefaultPrimaryContentrelationshipItem>
	>;
}
...
/**
 * Item in *Integrations → Default → Primary → groupicons*
 */
export interface IntegrationsSliceDefaultPrimaryGroupiconsItem {
	/**
	 * Icon field in *Integrations → Default → Primary → groupicons*
	 *
	 * - **Field Type**: Select
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.default.primary.groupicons[].icon
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	icon: prismic.SelectField<'npm' | 'cloudflare' | 'github' | 'figma' | 'digitalocean' | 'fly'>;
}
...
export interface IntegrationsSliceDefaultPrimary {
	...
	/**
	 * groupicons field in *Integrations → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.default.primary.groupicons[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	groupicons: prismic.GroupField<Simplify<IntegrationsSliceDefaultPrimaryGroupiconsItem>>;
}
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			CaseStudiesSlice,
			CaseStudiesSliceDefaultPrimaryContentrelationshipItem,
			...
			HeroSliceDefault,
			IntegrationsSlice,
			IntegrationsSliceDefaultPrimaryGroupiconsItem,
